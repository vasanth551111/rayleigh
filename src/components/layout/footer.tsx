    ...
    <footer className="bg-background border-t border-border pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 lg:col-span-2">
            ...
            <p className="text-muted-foreground text-sm max-w-xs mb-6">
              Master Interviews with AI. Land Your Dream Job. The ultimate AI-powered interview training platform.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li><Link href="#" className="hover:text-foreground transition-colors">AI Interviewer</Link></li>
              <li><Link href="#" className="hover:text-foreground transition-colors">Resume Analyzer</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li><Link href="#" className="hover:text-foreground transition-colors">Interview Guide</Link></li>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} Rayleigh AI. All rights reserved.</p>
