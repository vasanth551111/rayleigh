      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-card rounded-2xl p-8 shadow-xl">
          <form className="space-y-4">
            ...
            <Button type="button" className="w-full h-11 bg-primary hover:bg-primary/90 mt-2">
              <Link href="/dashboard" className="w-full h-full flex items-center justify-center">Sign in</Link>
            </Button>
          </form>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button variant="outline" className="h-11 border-border bg-background hover:bg-muted">
